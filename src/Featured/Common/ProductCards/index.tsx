...
const ProductCard: React.FC<Card> = ({
  ...
  return (
    <div>
      ...
      {OpenBasketModal && (
        <div className="fixed inset-0 bg-[#ffffff7f] backdrop-blur-[3px] z-[7777]">
          <div className="bg-[white] shadow-lg rounded-2xl  w-[1100px] h-[700px] absolute top-1/2 left-1/2 overflow-hidden transform -translate-x-1/2 -translate-y-1/2 inset-0  z-[9999] p-8">
            <div className="flex items-center justify-between">
              ...
              <div className="shadow-lg w-[40px] h-[40px] rounded-full flex items-center justify-center">
                <X size={20} />
              </div>
            </div>
            <div className="grid grid-cols-12 gap-6 mt-5">
              <div className="col-span-8  ">
                <div className="flex flex-col gap-4 h-[300px] overflow-y-scroll ">
                  <div className="flex items-center justify-between border border-gray-200 rounded-[6px] p-2.5 relative">
                    <div className="flex items-start gap-1.5">
                      <div className="absolute -bottom-3 transform -translate-x-1/2 left-1/2 w-[25px] h-[25px] flex items-center justify-center bg-[#e4e4e4] rounded-full p-1 hover:bg-blue-500 hover:text-white duration-300 cursor-pointer">
                        <Trash size={15} color="gray" />
                      </div>
                      <div>
                        <img
                          src="https://nov-one.myshopify.com/cdn/shop/products/1_2fff6d1b-7c77-40bf-a199-e6b7e28365e4_95x.jpg?v=1681294209"
                          alt=""
                    ...
                    <div className="flex items-center gap-8">
                      <div className="price ">
                        <h3 className="text-[13px] font-extrabold">$139.00</h3>
                      </div>
                      ...
                      <div className="price ">
                        <h3 className="text-[16px] font-extrabold">$139.00</h3>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center justify-between border border-gray-200 rounded-[6px] p-2.5 relative">
